...
Create a toolkit file containing all your tools, then register it using `useAui()`:
...
import { defineToolkit, useToolArgsStatus } from "@assistant-ui/react";
